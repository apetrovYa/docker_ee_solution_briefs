..  _splunk_additional_information:
...
* `Splunk Best Practices <http://dev.splunk.com/view/logging/SP-CAAAFCK>`_

Monitoring & Troubleshooting
----------------------------

* `Splunk Trouble shooting <https://wiki.splunk.com/Deploy:Troubleshooting>`_
* `Splunk Troubleshooting Monitor Input <https://wiki.splunk.com/Community:Troubleshooting_Monitor_Inputs>`_

Further Reading & Contact
-------------------------

* `Splunk Documentation <http://docs.splunk.com/Documentation>`_
